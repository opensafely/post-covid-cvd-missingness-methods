...
write.csv(
  df_ami,
  paste0(table1_dir, "table1-cohort_", cohort, preex_string, "_ami.csv"),
  row.names = FALSE
)

write.csv(
  df_sahhs,
  paste0(table1_dir, "table1-cohort_", cohort, preex_string, "_sahhs.csv"),
  row.names = FALSE
)
...
write.csv(
  df_ami,
  paste0(table1_dir, "table1-cohort_", cohort, preex_string, "_ami-midpoint6.csv"),
  row.names = FALSE
)

write.csv(
  df_sahhs,
  paste0(table1_dir, "table1-cohort_", cohort, preex_string, "_sahhs-midpoint6.csv"),
  row.names = FALSE
)
