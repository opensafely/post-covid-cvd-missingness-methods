...
#    (output/post_hoc_vars/input_{cohort}_subsample.rds)
#
# Authors: Emma Tarmey
#
# ------------------------------------------------------------------------------
...
# Define post_hoc_vars output folder ---------------------------------------
print("Creating output/post_hoc_vars output folder")

post_hoc_vars_dir <- "output/post_hoc_vars/"
dir_create(here::here(post_hoc_vars_dir))
...
saveRDS(
  df_ami,
  file = paste0(post_hoc_vars_dir, "input_", cohort, "_clean_subsample_ami.rds"),
  compress = TRUE
)

saveRDS(
  df_sahhs,
  file = paste0(post_hoc_vars_dir, "input_", cohort, "_clean_subsample_sahhs.rds"),
  compress = TRUE
)
